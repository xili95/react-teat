...
- Because we maintain 100% coverage, see [index.js](https://github.com/bitinn/node-fetch/blob/master/test/index.js) for a full list of custom `FetchError` types, as well as some of the common errors from Node.js
